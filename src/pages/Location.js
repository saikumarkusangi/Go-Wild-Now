...
function Location() {
  return (
         ...
         <div className="z-0  absolute top-[20%]  md:bg-transparent gap-4 md:left-[40%] flex flex-col md:gap-8">
              <h1 className="text-[#f8fbfe] text-2xl md:text-6xl font-medium px-10 ">About Us</h1>
          <div className='flex  justify-center gap-10 rounded-full py-4   bg-white'>
           ...
           <div className='flex  w-full mt-10  border-black border-t-white '>
            <img className='' src={images.About} alt='about'/>
            <div className='  border-white border-2  '>
            <h1 className='text-4xl text-center font-bold ml-12 px-10 py-4 font-Oswald text-[#f9430a] '> We Love Camping Make Happy Everyone</h1>
            <p className='text-xl px-4 leading-10 mt-10 '>Campers span a broad range of age, ability, and ruggedness, and campsites are designed in many ways as well.
                  ...
                  <button className='text-xl bg-[#f9430a] px-4 py-2 rounded-full mt-10 ml-4 '>Read More</button>
            </div>
