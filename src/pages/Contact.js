    ...
    <div className=' m-auto w-full py-16 '>
      ...
      <div className='grid md:grid-cols-2'>
        <img
          ...
          alt='/'
          className='border-black border-2 md:w-full shadow-2xl shadow-gray-800 w-[90%]  object-[40%] h-[50vh] md:h-full object-cover p-2 max-h-[500px] rounded-lg ml-6 '/>
        <form className='border-black border-2   md:h-full shadow-2xl  md:w-[80%]  w-[90%] md:ml-16 ml-6 gap-3 rounded-lg md:mt-0 mt-10'>
          <div className='grid grid-cols-2 mt-8 px-4 gap-3 '>
                <input className=' m-2 border-black border-2 rounded-full px-5 py-4 font-semibold text-lg text-black' type='text' placeholder='First' />
                ...
                <textarea className='border border-black col-span-2 m-2  ' cols='8' rows='4'>Write Your Message</textarea>
                <button className='col-span-2 m-2  border-2 rounded-full px-1 py-1 bg-cyan-400  text-black text-lg top-4' >Get A Quote</button>
          </div>
        </form>
      </div>
    </div>
